...
function loadPatreonButton() {
    ...
    xhr.onload = function () {
        if (xhr.status === 200) {
            ...
            $('#patreon-button').html(`<a className="patreon-button link-button" data-patreon-widget-type="become-patron-button" href="${url}" rel="noreferrer">Become a Patron</a><svg
        id="patreon-logo"
